...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    try {
      setError('')
      const apiUrl = import.meta?.env?.VITE_API_URL || import.meta?.env?.REACT_APP_API_URL || 'http://localhost:8000/api'
  ...
  return (
    <div className="min-h-screen pt-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        >
          <h1 className="text-5xl font-bold gradient-text mb-6">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-primary-600 bg-white/10 border-white/20 rounded focus:ring-primary-500 focus:ring-offset-gray-800"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="flex items-center justify-center space-x-2 px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 transition-colors"
              >
        ...
        >
          <h3 className="text-lg font-semibold text-white text-center mb-4">Why Sign In?</h3>
          <div className="grid grid-cols-1 gap-3">
            {[
              { icon: User, text: 'Access your personalized dashboard' },
              { icon: Lock, text: 'Secure access to research data' },
              { icon: Mail, text: 'Receive research updates and notifications' }
            ].map((feature, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, x: -20 }}
