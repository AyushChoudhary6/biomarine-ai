...
output "ecr_backend_repository_url" {
  ...
  value       = aws_ecr_repository.biomarine_backend.repository_url
}

output "ecr_frontend_repository_url" {
  description = "URL of the ECR repository for frontend"
  value       = aws_ecr_repository.biomarine_frontend.repository_url
}
...
output "useful_commands" {
  ...
  value = {
    ...
    get_biomarine_pods = "kubectl get pods -n biomarine"
    ...
    ecr_login          = "aws ecr get-login-password --region ${var.aws_region} | docker login --username AWS --password-stdin ${aws_ecr_repository.biomarine_backend.repository_url}"
  }
}